...
public class Main {
    ...
    public static void initializeSystem(ServiceCenter serviceCenter){
        ...
        for(int j = 1; j < 3; j++){
            ArrayList<Integer> ambulanceList = serviceCenter.addAmbulance(j);
        }
    }
    ...
    public static void displayMenu(){
        ...
        ans += ":: Options:                                                                  ::" + "\n";
        ans += ":: 1. Add Patient                                                            ::" + "\n";
        ans += ":: 2. Remove Patient By Id                                                   ::" + "\n";
        ans += ":: 3. Assign Ambulance For Patient                                           ::" + "\n";
        ans += ":: 4. Assign Ambulance For Patient By Id                                     ::" + "\n";
        ans += ":: 5. Check Position By Id                                                   ::" + "\n";
        ans += ":: 6. Print Waiting List                                                     ::" + "\n";
        ans += ":: 7. Check Ambulance List                                                   ::" + "\n";
        ans += ":: 8. Add Ambulance                                                          ::" + "\n";
        ans += ":: 0. Exit                                                                   ::" + "\n";
        ans += "===============================================================================" + "\n";
        System.out.println(ans);
    ...
    public static int getOption(Scanner inputScan, int [] optionsAvailable){
        ...
        System.out.println(ans);
        int _option = checkInput(inputScan);
    ...
    public static int checkInput(Scanner inputScan){
        int id = 0;
        while(true){
            try{
                String idInput2 = inputScan.nextLine();
                id = Integer.parseInt(idInput2);
                break;
            }catch(Exception e){
    ...
    public static boolean performAction(ServiceCenter serviceCenter, int _option, Scanner inputScan){
        ...
        switch(_option){
            case 1:
                ...
                while(true){
                    try{
                        ...
                        triageLevel = getInput(inputScan, "Invalid input! Please enter one integer from 1 to 5: ");
                    }
                }
            ...
            case 2:
                clearScreen();
                printSubHeader("Delete Patient By Id");
                int id0 = checkInput(inputScan);
                Patient patient0 = serviceCenter.removePatientById(id0);
                //if(patient0 != null)
                waitInput(inputScan);
                break;
            case 3:
                ...
                Patient patient1 = serviceCenter.assignAmbulanceForPatient();
                //if(patient1 != null)
                waitInput(inputScan);
                break;
            case 4:
                ...
                int id1 = checkInput(inputScan);
                Patient patient2 = serviceCenter.assignAmbulanceById(id1);
                //if(patient2 != null)
                waitInput(inputScan);
                break;
            case 5:
                ...
                int id2 = checkInput(inputScan);
                Patient patient3 = serviceCenter.CheckPositionById(id2);
                //if(patient3 != null)
                waitInput(inputScan);
                break;
            case 6:
            ...
            case 7:
                clearScreen();
                printSubHeader("Ambulance List");
                serviceCenter.printAmbulanceList();
                waitInput(inputScan);
                break;
            case 8:
                clearScreen();
                printSubHeader("Add Ambulance");
                System.out.println("Please enter NO. of the ambulance: ");
                int ambulanceNumber = checkInput(inputScan);
                serviceCenter.addAmbulance(ambulanceNumber);
                waitInput(inputScan);
                break;
            case 0:
                exitMessage();
    ...
    public static void main(String[] args) {
        ...
        int [] options = new int []{1,2,3,4,5,6,7,8,0};
