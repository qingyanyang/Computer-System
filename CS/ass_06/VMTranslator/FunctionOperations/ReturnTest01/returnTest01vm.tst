// Sample Test file for vm_returnTest01.vm
// Follows the Test Scripting Language format described in 
// Appendix B of the book "The Elements of Computing Systems"

load returnTest01.vm,
output-file returnTest01.cmp,
...
repeat 20 {        // Change this number to cover the number of instructions in the VM test file
  vmstep;
}
output;
